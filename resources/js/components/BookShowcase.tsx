...
const BookShowcase: React.FC = () => {
    ...
    const FallbackView = (
        <div className="w-full h-full flex items-center justify-center">
            <div className="relative w-64 aspect-[2/3] bg-[#1f2937] shadow-2xl rounded-sm transform rotate-[-6deg] flex items-center justify-center border-l-4 border-[#fbbf24]">
                <div className="text-center p-6 border-2 border-white/10 w-[90%] h-[90%] flex flex-col justify-between">
                    <span className="text-[10px] uppercase tracking-[0.2em] text-gray-400 block">Limited</span>
                    <div className="w-16 h-16 rounded-full border border-gray-600 mx-auto flex items-center justify-center">
                        <span className="text-2xl serif text-[#fbbf24] italic">N</span>
                    </div>
                    <span className="text-xs uppercase tracking-widest text-white block font-bold serif">Edition</span>
                </div>
            </div>
        </div>
    );
